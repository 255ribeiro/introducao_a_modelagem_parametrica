...
2. [Introdução à Modelagem Paramétrica](docs/slides/Intro_modelagem_param_MBI_BIM.pdf)

_______

### Introdução - parte 2

![alt text](docs/slides/Fluxograma_design_generativo.png)

1. Interface do Grasshopper

   - [Janela do Grasshopper](docs/gh_interface/gh_inter.md)
   - [Sliders](docs/Slider/Slider_config.md)
   - [Panels](docs/Panels/Painel_config.MD)
   - Pontos
   - Vetores
   - Linhas
   - Nurbs
...
2. Atividade 01
   ...
   - [Sequência de pilares](docs/gh_pilares/gh_pilares.md)

   - [Grasshopper Exemplos](docs/gh_exemplos/gh-exemplos.md)

_______

### Atividade 02 - parte 1

1. [Manipulação de listas](docs/gh_list_intro/gh_list_basics.md)

- Seleção de um elemento de uma lista pelo **Índice**
- Exclusão de um elemento de uma lista pelo **Índice**
- **Shift List**

1. [Vetores e Planos](docs/gh_vect_plane/vect_plane_basics.md)
...
![brise_parte_01](docs/gh_brise/exemplo_brise_parte_01.png)

- [Clusters](docs/gh_clusters/clusters.md)
  
- Domínios
  
- [Arquivo final](docs/gh_brise/brise_parametrico_2021.gh)
...
[exemplos fluxo de trabalho](docs/dl_assets/projeto_mpsd.zip)

[exemplos fluxo de trabalho - pt2](docs/dl_assets/TER_01_terreno_3d_V00.gh)

[exemplos fluxo de trabalho - pt3](docs/dl_assets/projeto_mpsd/projeto_mpsd/Terreno/TER_02_mov_de_terra_V00.gh)

### Interoperabilidade

[Principais plugins de interoperabilidade](docs/interop/interop.md)
